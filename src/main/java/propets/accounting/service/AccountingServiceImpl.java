...
public class AccountingServiceImpl implements AccountingService {
    ...
    public ResponseEntity<UserInfoDto> tokenValidation(String token) {
        UserInfoDto userInfoDtoA = tokenService.validateToken(token);
        HttpHeaders headers = new HttpHeaders();
        headers.add(tokenName, userInfoDtoA.getToken());
        return new ResponseEntity<UserInfoDto>(userInfoDtoA, headers, HttpStatus.OK);
    }
